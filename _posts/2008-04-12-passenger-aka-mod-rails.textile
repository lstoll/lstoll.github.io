...
Passenger is now available for download - http://www.modrails.com . If you havenât heard of it, is basically an apache module for running rails apps - nice and easily. Iâve just moved it over to this site, and it was incredibly easy. The install on my ubuntu server went like this:
...
Then, when apache started up it automatically started the rails app, and it just worked. Itâs simple to use with capistrano, hereâs my deploy tasks from deploy.rb:
