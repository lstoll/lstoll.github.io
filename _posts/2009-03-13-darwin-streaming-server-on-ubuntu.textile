...
I've got a 64 bit version of the package available now as well. Please note it has had very little testing - please try it out, and report any bugs you find. You can download it here: <a href="http://static.lstoll.net/dss/DarwinStreamingSrvr6.0.3-L2-Linux-x64.deb.gz">http://static.lstoll.net/dss/DarwinStreamingSrvr6.0.3-L2-Linux-x64.deb.gz</a>
